...
//    infoBox.snapshotRect = QRectF(40,1082, size, size);
...
////        font.setBold(false);
////        painter->setFont(font);
////        painter->drawText(QRect(204, 91, 150, 162), flags, QString(ip));
////        qDebug("ip:%s",ip);
////    }
...
////    painter->drawImage(QRect(10, 1028, 780, 243), QImage(":/images/bg_bottom.png"));
...
////    font.setBold(false);
////    painter->setFont(font);
////    painter->drawText(QRect(204, 1091, 150, 62), flags, timeData);

////    QString date = time.toString("yyyy/MM/dd  dddd");
////    font.setPixelSize(32);
////    font.setBold(false);
////    painter->setFont(font);
////    painter->drawText(QRect(204, 1169, 500, 38), flags, date);
...
//   painter->drawImage(QRect(10, 1028, 780, 243), QImage("./images/bg_bottom.png"));
//  if(!bShowInfo) {
//      painter->drawImage(infoBox.snapshotRect, QImage(Picture));
//  } else {
//      painter->drawImage(infoBox.snapshotRect, defaultSnapshot);
